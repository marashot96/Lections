...
<p align='justify'> Добро пожаловать на информативное описание занятия. На данном занятии мы прошли определение **ковариации** двух случайных величин, линейную **корреляцию Пирсона**, ранговую **корреляцию Спирмена**, **корреляцию Мэтьюнса**,понятие таблица сопряженности, **Корреляцию Крамера**.  </p>
