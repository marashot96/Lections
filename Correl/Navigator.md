...
| 3 | [`Таблица значений t-критерия`](/Correl/t-kr.jpeg) | Таблица значений критерия $t$ с $\alpha$ уровнем достоверности и $k$ степенями свободы |
| 4 | [`Таблица значений хи-квадрат критерия`](/Correl/chi_2.png) | Таблица значений критерия $\chi^2$ с $\alpha$ уровнем достоверности и $df$ степенями свободы |
